...
const Footer = (props: Props) => {
  return (
    <div className="flex flex-row justify-center items-center border-t-4 sm:mt-18 w-full mt-14 sm:p-6 p-4 bg-gradient-to-r from-[#71B6CF] to-cyan-900">
      ...
      <div className="sm:p-10 p-3">
        <Link
          href="/"
          className="sm:text-2xl text-xs sm:font-semibold font-medium duration-300 bg-white sm:hover:font-bold hover:font-bold hover:bg-cyan-600 sm:px-3 px-2 sm:py-1 py-1 rounded border-2 shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,1)]"
        >
          Home
        </Link>
      </div>
